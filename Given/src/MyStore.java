...
class RequestQueue {
    ...
    void enQueue(String type, int amount) {
        //You should write here appropriate statements to complete this function.
        //--------------------------------------------------------
        Node newNode = new Node(new Fruit(type, amount));
        if(front == null){
            front = newNode;
            rear = newNode;
            return;
...
class MyStore {
    ...
    void f2() throws Exception {
        ...
        //You should write here appropriate statements to complete this function.
        //--------------------------------------------------------
        Fruit rTmp = RQueue.deQueue();
        Fruit fTmp = FList.searchNode(rTmp.getType());
        if(fTmp != null){
            if(fTmp.getAmount() >= rTmp.getAmount()){
                fTmp.setAmount(fTmp.getAmount() - rTmp.getAmount());
            }
        }
        //---------------------------------------------------------
        ftraverse(f);
